...
<head>
<meta charset="UTF-8">
<title>ie 7 JC.com Welcome!</title>
<style>
*{margin:0; padding:0;}
...
<body>
	<div id="header">
			<p>looks like your using <span class="big">Internet Explorer</span> version#<span class="big"><?=$browser_version?></span>, please update to one of the following, thanks!</p>
		<ul class="center">
